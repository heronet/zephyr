...
enum fido2_status {
	...
	FIDO2_ERR_CREDENTIAL_EXCLUDED = 0x19,   /**< Credential already registered */
...
struct fido2_device_info {
	...
	uint8_t transports;
	/** Client PIN configured */
	bool pin_configured;
	/** User verification configured */
	bool uv_configured;
